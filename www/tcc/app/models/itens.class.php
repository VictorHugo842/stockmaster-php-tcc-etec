...
*/
 ...
 class Itens extends Connect
 {
  ...
  <!-- Modal -->
<div>
  <form id="delItens'.$row['idItens'].'" name="delItens'.$row['idItens'].'" action="../../app/Database/deleteitens.php" method="post" style="color:#000;">
  ...
  { 
   ...
   public function DeleteItens($value)
    {
