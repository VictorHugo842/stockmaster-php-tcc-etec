...
<div class="modal fade" id="myModal'.$row['CodRefProduto'].'" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <form id="delprod'.$row['CodRefProduto'].'" name="delprod'.$row['CodRefProduto'].'" action="../../app/Database/deleteprod.php" method="post" style="color:#000;">
  ...
  <form id="Upprod'.$row['CodRefProduto'].'" name="Upprod'.$row['CodRefProduto'].'" action="../../app/Database/insertprod.php" method="post" style="color:#000;">
	...
	<div class="modal-dialog" role="document">
	  <div class="modal-content">
		<div class="modal-header">
		  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
		  <h4 class="modal-title" id="myModalLabel">Você tem certeza que deseja alterar o nome deste produto ?</h4>
		</div>
		<div class="modal-body">
		  Nome Atual:
...
public function InsertProdutos($NomeProduto, $idUsuario){
...
public function UpdateProdutos($id, $NomeProduto, $idUsuario)
{
...
public function DeleteProdutos($value)
	{
