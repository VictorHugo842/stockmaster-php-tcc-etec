...
$url = 'http://localhost/www/tcc/views/';
...
$header = '<header class="main-header">
    ...
    <a href="'.$url.'index.php" class="logo">
      ...
      <span class="logo-mini"><b>ST</b>CK</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Stock</b>Master</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  '.$usuario.'
                  <small>'.date('d/m/Y', strtotime($dataregistro)).'</small>
                </p>
              </li>
              <!-- Menu Body -->
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="'.$url.'usuario/profile.php" class="btn btn-default btn-flat">Perfil</a>
                </div>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="'.$url.'relatorio/"><i class="fa fa-circle-o"></i>Totais de Itens</a></li>
      ...
      <ul class="treeview-menu">
        ...
        <ul class="treeview-menu">
          <li><a href="'.$url.'usuario/"><i class="fa fa-circle-o"></i>Usuários</a></li>
          <li><a href="'.$url.'usuario/addusuario.php"><i class="fa fa-circle-o"></i>Adicionar Usuários</a></li>
        </ul>
      </li>
      ...
      <ul class="treeview-menu">
        ...
        <li><a href="'.$url.'cliente/addcliente.php"><i class="fa fa-circle-o"></i>Adicionar Clientes</a></li>
      </ul>
    </li>
    ...
    <ul class="treeview-menu">
      <li><a href="'.$url.'relatorio/"><i class="fa fa-circle-o"></i>Produtos e Vendas</a></li>
    </ul>
  </li>
        ...
        <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> <span>Informativo</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>';
